    ...
    return (
        ...
        <h3>Check Out Some of My Projects.</h3>
            <div className='works-container'>
                ...
                <Work image={Poster} title="Poster Design" subTitle="Graphic Design" text="Social Media banners created using various design tools such as Adobe Photoshop and Adobe Illustrator." codeLink="" />
